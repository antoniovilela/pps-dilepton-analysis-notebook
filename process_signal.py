...
for key_ in fileNames_signals:
    if base_path is not None and base_path != "":
        fileNames_signals[ key_ ] = [ "{}/{}".format( base_path, item_ ) for item_ in fileNames_signals[ key_ ] ]
...
for label_ in labels_signals:
    ...
    with pd.HDFStore( file_path_, 'w', complevel=5 ) as store_:
        df_counts_, df_protons_multiRP_, df_protons_singleRP_ = get_data( fileNames_signals[ label_ ], version='V2' )
